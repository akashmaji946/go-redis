...
import "github.com/akashmaji946/go-redis/internal/common"
...
func NewMem(config *common.Config) *Mem {
	return &Mem{
		Maxmemory:       config.Maxmemory,
		Maxmemorysample: config.Maxmemorysample,
...
func sampleKeysRandom(state *common.AppState) []Sample {

	numSamples := state.Config.Maxmemorysample
