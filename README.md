...
**Key**
`DEL`, `DELETE`, `EXISTS`, `EXPIRE`, `KEYS`, `PERSIST`, `RENAME`, `SCAN`, `TTL`, `TYPE`

**Transaction**
`DISCARD`, `EXEC`, `MULTI`, `UNWATCH`, `WATCH`

**Hash**
`HDEL`, `HDELALL`, `HEXISTS`, `HEXPIRE`, `HGET`, `HGETALL`, `HINCRBY`, `HINCRBYFLOAT`, `HKEYS`, `HLEN`, `HMGET`, `HMSET`, `HRANDFIELD`, `HSCAN`, `HSET`, `HSETNX`, `HSTRLEN`, `HVALS`
