...
**Server**
`COMMAND`, `COMMANDS`, `DBSIZE`, `DROPDB`, `FLUSHALL`, `FLUSHDB`, `INFO`, `MONITOR`, `SIZE`, `TIME`
...
**Hash**
`HDEL`, `HDELALL`, `HEXISTS`, `HEXPIRE`, `HGET`, `HGETALL`, `HINCRBY`, `HINCRBYFLOAT`, `HKEYS`, `HLEN`, `HMGET`, `HMSET`, `HRANDFIELD`, `HSET`, `HSETNX`, `HSTRLEN`, `HVALS`

**List**
`BLMOVE`, `BLPOP`, `BRPOP`, `LGET`, `LINDEX`, `LINSERT`, `LLEN`, `LMOVE`, `LPOP`, `LPOS`, `LPUSH`, `LREM`, `LRANGE`, `LSET`, `LTRIM`, `RPOP`, `RPOPLPUSH`, `RPUSH`

**PubSub**
`PSUBSCRIBE`, `PSUB`, `PUB`, `PUBLISH`, `PUNSUBSCRIBE`, `PUNSUB`, `SUB`, `SUBSCRIBE`, `UNSUB`, `UNSUBSCRIBE`

**Set**
`SADD`, `SCARD`, `SDIFF`, `SDIFFSTORE`, `SINTER`, `SINTERSTORE`, `SISMEMBER`, `SMEMBERS`, `SMISMEMBER`, `SMOVE`, `SPOP`, `SRANDMEMBER`, `SREM`, `SUNION`, `SUNIONSTORE`

**Sorted Set (ZSet)**
`BZPOPMAX`, `BZPOPMIN`, `ZADD`, `ZCARD`, `ZCOUNT`, `ZGET`, `ZINCRBY`, `ZINTERSTORE`, `ZLEXCOUNT`, `ZMSCORE`, `ZPOPMAX`, `ZPOPMIN`, `ZRANGE`, `ZRANGEBYLEX`, `ZRANGEBYSCORE`, `ZRANK`, `ZREM`, `ZREMRANGEBYLEX`, `ZREMRANGEBYRANK`, `ZREMRANGEBYSCORE`, `ZREVRANGE`, `ZREVRANGEBYSCORE`, `ZREVRANK`, `ZRANDMEMBER`, `ZSCAN`, `ZSCORE`, `ZUNIONSTORE`
